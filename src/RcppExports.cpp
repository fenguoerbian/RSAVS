...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(RSAVS_Solver_Cpp(y_vec, x_mat, n, p, l_type, l_param, p1_type, p1_param, p2_type, p2_param, const_r123, const_abc, tol, max_iter, cd_tol, cd_max_iter, initial_values, additional_values, phi, omp_zsw, eigen_pnum));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_RSAVS_RSAVS_Solver_Cpp", (DL_FUNC) &_RSAVS_RSAVS_Solver_Cpp, 21},
