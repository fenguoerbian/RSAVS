...
RSAVS_Solver_Cpp <- function(y_vec, x_mat, n, p, l_type, l_param, p1_type, p1_param, p2_type, p2_param, const_r123, const_abc, tol, max_iter, cd_tol, cd_max_iter, initial_values, additional_values, phi, omp_zsw, eigen_pnum) {
    .Call(`_RSAVS_RSAVS_Solver_Cpp`, y_vec, x_mat, n, p, l_type, l_param, p1_type, p1_param, p2_type, p2_param, const_r123, const_abc, tol, max_iter, cd_tol, cd_max_iter, initial_values, additional_values, phi, omp_zsw, eigen_pnum)
}
